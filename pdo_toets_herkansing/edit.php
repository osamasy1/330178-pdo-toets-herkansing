...
<div class="container">
    <div class="mb-3">
      <h1 class="text-center">Edit je data</h1>
    </div>
    <form action="./edit_script.php" method="POST">
      <div class="mb-3">
        <label for="burritoformaat" class="form-label">burritoformaat</label>
        <select class="form-select" aria-label="Default select example" name="burritoformaat">
      ...
      <div class="mb-3">
        ...
        <div class="form-check">
          <input class="form-check-input" name="rijst" type="checkbox" value="Bruine_rijst" id="flexCheckChecked" >
